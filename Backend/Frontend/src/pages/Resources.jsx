    ...
    <div className="bg-gradient-to-b from-mist-50 to-white pb-20 pt-10">
      <div className="mx-auto max-w-6xl px-4">
        <header className="mb-8">
          <h1 className="font-display text-3xl font-bold text-slate-900 dark:text-white">Resources & Docs</h1>
        ...
        <section className="mb-6 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-soft">
          <h2 className="font-semibold text-slate-900 dark:text-white">Core platform features</h2>
        ...
        <section className="mb-6 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-soft">
          <h2 className="font-semibold text-slate-900 dark:text-white">What changed in this sprint</h2>
          <ul className="mt-3 list-inside list-disc space-y-2 text-slate-600 dark:text-slate-400">
        ...
        <section className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-soft">
          <h2 className="font-semibold text-slate-900 dark:text-white">Next implementation tasks</h2>
          <ul className="mt-3 list-inside list-disc space-y-2 text-slate-600 dark:text-slate-400">
        ...
        <div className="mt-8 text-sm text-slate-500 dark:text-slate-400">
          <Link to="/" className="font-medium text-sage-600 dark:text-sage-400 hover:underline">
            ← Back to homepage
          </Link>
        </div>
      </div>
